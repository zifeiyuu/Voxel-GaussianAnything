...
class arkitscenesDataset(Dataset):
    ...
    def _load_pose_data(self):
        ...
        file_path = self.dataset_folder / f"{self.split_name_for_loading}_data.pickle.gz"
    ...
    def _generate_defined_indices(self, gap1=-1, gap2=0, gap3=1):
        ...
        for key in self._seq_keys:
            ...
            key_id_pairs.append((key, [src_idx, tgt_1_idx, tgt_2_idx, tgt_3_idx]))
    ...
    def __getitem__(self, index):
        ...
        for frame_name, frame_idx in zip(frame_names, src_and_tgt_frame_idxs):
            ...
            img_name = pose_data['images'][frame_idx] + '.png'
            ...
            depth_name = pose_data['images'][frame_idx] + '.png'
            ...
            # Additional metadata
            first_img_name = pose_data['images'][0]  # The source frame
