...
class PointTransformerLayer(nn.Module):
    def __init__(self, in_planes, out_planes, share_planes=8, nsample=16, norm_type="BN"):
        super().__init__()
        ...
        self.linear_w = nn.Sequential(
            # BatchNorm1d(mid_planes),
            norm_fn(mid_planes),
            nn.ReLU(inplace=True),
            nn.Linear(mid_planes, out_planes // share_planes),
            # BatchNorm1d(out_planes // share_planes),
            norm_fn(out_planes // share_planes),
            nn.ReLU(inplace=True),
...
class PointTransformerV1(nn.Module):
    def __init__(self, block, blocks, in_channels=6, planes=[32, 64, 128, 256, 512], stride=[1, 4, 4, 4, 4], nsample=[8, 16, 16, 16, 16]):
        super().__init__()
        self.in_channels = in_channels
        self.in_planes, planes = in_channels, planes
...
class PointTransformerV1_26(PointTransformerV1):
...
class PointTransformerV1_38(PointTransformerV1):
    def __init__(self, **kwargs):
        super().__init__(
...
class PointTransformerV1_50(PointTransformerV1):
    def __init__(self, **kwargs):
        super().__init__(
